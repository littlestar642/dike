...
import {View, Text, SafeAreaView, Button, ActivityIndicator, Modal, StyleSheet} from 'react-native';
          ...
          <SafeAreaView style={styles.modalContainer}>
            <View style={styles.header}>
              ...
              <View style={styles.cancel}>
                <Button
                  title={cancelLabel || RecaptchVerifier.defaultProps.cancelLabel}
                  onPress={this.cancel}
                />
              </View>
            </View>
...
export default RecaptchVerifier;
